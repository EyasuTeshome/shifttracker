...
Most of them were used during the Admission process, so you should have them already on your machine, but this is the final check.
In the following modules, we will also ask you to install other tools but only at the moment when they start to be useful.


### Why is it important?

Very soon, you will start coding your first projects. Having all tools set up ahead of time will save you time.
...
- [Configure your GitHub account to use your SSH key](https://docs.github.com/en/github/authenticating-to-github/adding-a-new-ssh-key-to-your-github-account). So you can push your code to GitHub quickly.
...
Most employers will be really impressed to see a consistent list of commits in your projects, and even more, if there are multiple people in the list of commits (e.g., you and your coding partner) showing that you were working as part of a distributed/remote team.
