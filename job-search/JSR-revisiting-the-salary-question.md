...
3. Do some research about current salaries for similar positions:
    ...
    - Use tools such as [Glassdoor.com](http://Glassdoor.com), [Salary.com](https://www.salary.com/), [Clockify's Hourly Rate Calculator](https://clockify.me/hourly-rate-calculator)
4. Identify the lowest and the highest salaries paid currently. to determine the range.
5. Analyze your financial needs and adjust the range you identified. For example, the lowest salary might not be enough for you, so increase it to meet your minimal income. 
...
- If you feel uncomfortable and don’t want to answer the question, you can avoid it by making reference to other professional priorities such as:
     *“I am flexible because I focus more on opportunities to learn and grow with solid mentorship.”
...
- A recruiter may ask about your previous salary. Try to dodge it graciously so that it’s not used as a reference to define the salary they offer you. You can say something like:
     *“My previous experience was unrelated to web development and not aligned with my current skill set. As I move into my new career path, I expect a salary in the range of X to X.”*

## Additional information and support

Microverse career coaches can help you define and negotiate your salary. In the job searching modules, you will be assigned a coach to discuss this issue. If you need some help before, reach out to career services and schedule a meeting with a coach.
...
1. Open the [t](https://docs.google.com/document/d/1eyUSH_ErfM6tFlJWoeabZRuXcpFO_n9Kva1GIkECKj0/edit?usp=sharing)emplate.
