...
6. Now, analyze if your resume meets each and every one of the requirements of the [resume rubric](https://docs.google.com/document/d/1lxBFRdvPW_cLQpX8n_gj8O8t1XPcXjGTDOCI813Uga0/edit). Use the [Assess your resume worksheet](https://docs.google.com/document/d/1fFPrgM1mEOAI61AW5gmpTnmbCV7xcENYIp5Fof-yhkU/edit#) to register your scores and to find the learning resources that you can use to improve your resume. **You don't need to submit this worksheet**, but we recommend that you keep a copy at hand as a reference while you do rounds of revision of your resume this week. 
