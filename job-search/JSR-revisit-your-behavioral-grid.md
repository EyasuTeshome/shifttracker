...
In a previous module, you created the first version of your behavior grid, with four stories based on a project or experience and using SAR. Now, you will update these stories by applying the CARL (Context, Action, Result, Learning) that you have just learned. You will also create a spreadsheet to integrate all the stories you have written into one file and add an additional story to each question.
...
Taking the time to draft each story and think carefully about what you want to say about the four elements in CARL will help you give compelling answers to behavioral questions in your interview.
...
3. Copy each of the stories you have created to the template, separating the **C**ontext (the **Si**tuation, in your original story), the **A**ctions, and the **R**esults.
4. Read the **R**esults carefully. Analyze if you cover both results and lessons lgoearned, and separate them in the corresponding cells. If you haven’t described the lessons learned explicitly, add them now. Think of the long-term impact of the experience on you as a professional.
5. Copy to the template the two stories that you created with the CARL framework and submitted to a coach for review.
