...
1. Select a job posting that you are interested in applying for. You can refer to the resource [“Where do I find jobs to apply to?](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/where-do-I-find-jobs-to-apply-to.md) for ideas on where to look.
...
3. Read the cover letter that you wrote in Module 5.
4. Read the feedback that you received from reviewers and make sure you made the required changes.
5. Make a copy of the cover letter so that you can edit it for the new job posting that you have selected. Begin by looking at the heading; verify that the content is complete and all links are functional.
4. Now move to the different paragraphs: introduction, first, second, third, and conclusion. As a reminder, read in the walkthrough the content that each one should address. Rewrite or edit each paragraph to align it with the job posting that you have selected it.
5. Look now at the format of your cover letter: margins, line spacing, fonts. Is it attractive and consistent?
5. Read through the letter to analyze how the story that you are telling works. Are you communicating why you are fit for that specific job? Make any necessary edits to make your story more compelling.
6. Open the rubric and verify that your cover letter meets all the requirements.
