...
1. Open the link in the section above called "*How can I find jobs to apply to?*". Scroll down to the bottom of the page and you will see a list of remote website links.
2. Take some time to through some of these websites, and seek out **ONE** suitable role that you might want to apply to later in the future. **Do not get distracted and start applying to many roles**. This exercise is just for you to practice.
3. Open up your copy of the template and complete all sections.
