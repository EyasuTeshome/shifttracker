...
Now, you will revise and edit the professional profiles that you created on Linkedin and AngelList, before your coach reviews them. 
...
To review the AngelList profile:
- Open all written and numerical resume feedback from your project reviewer(s). You can find written feedback on your dashboard for each project under the **Action-->View Reviews** button.
- Open the [AngelList profile  rubric](https://docs.google.com/document/d/1lxBFRdvPW_cLQpX8n_gj8O8t1XPcXjGTDOCI813Uga0/edit).
- Open the [create the first draft of your AngelList profile](https://github.com/microverseinc/curriculum-professional-skills/blob/main/interview-prep/create-the-first-draft-of-your-angellist-profile.md) walkthrough.

## Do a final sweep of your LinkedIn and AngelList profiles 
