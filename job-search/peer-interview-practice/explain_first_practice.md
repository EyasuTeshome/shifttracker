...
1. In a big group, read the theory lesson [Deal with common issues during live coding: abrupt coders](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/explain_first_lesson.md) lesson.
    - Make sure that everybody understands the issue that is a theme of that lesson.

### Interviewers setup - 10 min

2. Everybody in your group will play the role of the interviewer at some point during the exercise, so each of you must follow the steps below:
    ...
    - Make yourself familiar with the [rubric for giving advice](https://docs.google.com/document/d/1aJDc4X45WmoftWhmDyPafq9ZcXPWBH8av6KhDdGfYpo/edit#)
