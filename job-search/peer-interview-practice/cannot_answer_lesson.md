# Deal with common issues during answering technical questions: cannot answer a question

## Description

There are a few strategies that can help you to answer a question in a difficult situation. For example [when you don't understand the question](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/not_clear_question_lesson.md) 
...
Even if this situation you can still behave in a way that proves your professionalism. 

(hint: ask for the correct answer as it shows that you are interested and you still can add something up to the answer once you recall the concept).
...
Review the following guidelines that will help you to act in a professional way in case you do not know an answer to a specific question.
