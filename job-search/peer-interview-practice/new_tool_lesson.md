# Deal with common issues during live coding: a new tool
...
The latter is a common practice because many online platforms support the recruitment process from the starting to the end.

While all online coding tools serve the same goal, each of them can be a little bit different.
As using a tool that can be completely new for you can add up to your stress level, it is good to try out different ones and practice how to get familiar with new tools quickly.
...
Review the following guidelines that will help you to make sure that you set up yourself for success when using an online tool that is completely new for you.
