...
2. In each interview, follow these steps:
    ...
    - **For this exercise purpose you need to pretend that you are not able to solve the challenge on time.**
        - Start writing your solution and spend maximum 2 minutes on that. 
    - After the first 2 monites of coding, the applicant's job is to apply the following the guidelines from [Deal with common issues during live coding: being in rush](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/in_rush_lesson.md)
