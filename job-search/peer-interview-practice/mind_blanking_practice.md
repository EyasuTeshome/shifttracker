# Deal with common issues during answering technical questions: mind-blanking
...
1. In a big group, read the theory lesson [Deal with common issues during answering technical questions: mind-blanking](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/mind_blanking_lesson.md).
...
1. Everybody in your group will play the role of the interviewer at some point during the exercise, so each of you must follow the steps below:
    ...
    - **Make sure that you - as an interviewer can answer the question - so you can help your peer by**
        ...
        - giving examples
        - giving hints
2. **Everybody makes themselves familiar with the [rubric for giving advice](https://docs.google.com/document/d/165bsZhqFEYr4M8NeqkfA6eOhmLdW-SBVCdbSxC0DfpA/edit#).**
...
2. In each interview, follow these steps:
    ...
    - **Act as if you have a mind-blanking for the exercise purpose. The goal is to practice the guidelines, so they will become a natural reaction for you if this issue happens during a real interview.**
    - **The applicant's job is to apply the following the guidelines from [Deal with common issues during answering technical questions: mind-blanking](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/mind_blanking_lesson.md)
