...
As mentioned in the [Take-home assignment practice: intro](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/take-home-assignments/take_home_intro.md#how-to-prepare-practically-for-take-home-assignments), there are two ways of how you can prepare for take-home assignments:
...
- [All repositories that include the "take-home" phrase written in Ruby](https://github.com/search?l=Ruby&q=take-home&type=Repositories)
- [All topics tagged as take-home-test (Ruby)](https://github.com/topics/take-home-test?l=ruby)
- [All repositories taht include "take-home" phrase written in JavaScript](https://github.com/search?l=Ruby&q=take-home&type=Repositories)
