...
In this lesson, you will review your long-term goal for networking and define the SMART goals you want to achieve this month. Doing so will refresh your understanding of what networking is and how to build your network.

### Why is building a professional network important?

You can be the best developer in the world. Still, if nobody knows about you or your skills, your chances of being hired — especially with a remote company — are significantly reduced. The internet has given us endless opportunities to connect with others worldwide. Networking lets you put yourself and your work out there: to showcase your projects and experiences and connect with like-minded people in the industry. Many job opportunities -for today and the future- come through connections, so investing your time in building and maintaining your network is a good idea. 

### What is networking, and how do you network?

Different ways to build your professional network include participating in online communities and networks, attending technical events and meetups, and making contacts through family and friends. For example, people from our personal circles might know someone that works in the tech sector!

But networking is more than just making contact with people: it's about building a connection and establishing relationships. Think of it as being similar to making friends in real life. It requires a constant effort and takes time.
...
**Refresh your understanding of networks and the different ways to build a network.** 
...
To organize your time and resources effectively, you must have in mind goals: a clear vision of what you want to achieve will contribute to your motivation and help you focus on the essential tasks. You can establish goals at different levels and time frames, but it’s a good practice to begin with the big picture and a long-term perspective. For example, the most common higher-level networking goals revolve around a chance to:
...
To get ideas on how to plan your network, read the article [Use research to plan a better network](https://tribemineblog.com/use-research-to-plan-a-better-network/).

Since networking is a strategy to access your dream jobs, it’s helpful to consider them when considering your big-picture networking goal. In the core program, you created a list, so it’s time to look at it again (if you didn’t make a list, do it now using [this lesson](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/define-your-dream-companies.md). 
...
3. Make a list of the qualities you want your network to have, considering sectors, companies, roles, areas of expertise, location, or any other relevant trait.
...
Once a clear vision of the professional network you want to build, you can set short-term goals that will help you move forward in that direction. Your starting point is the network you have created in the past few months and that you have mapped already.
...
1. Open the network map you created in [this exercise](https://github.com/microverseinc/curriculum-professional-skills/blob/main/job-search/map-your-network.md). Then, compare your current network to the long-term networking goal and the qualities listed in section 1. 
2. Think carefully about the changes you would like to make to your network and write some ideas in section 2.
