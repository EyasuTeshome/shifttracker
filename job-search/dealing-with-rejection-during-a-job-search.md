# Dealing with rejection during a job search
...
Since there are many candidates for one job, rejection is very common and will become part of your everyday life when job searching. Nevertheless, being rejected can be emotionally challenging, because it can impact your self-esteem and lead to demoralizing thoughts. So, learning to deal with rejection becomes critical for successful job searching.

### How can I face rejection positively?

There is no way to escape rejection during job searching, especially in the current job market. Yet, you can learn to face it in a way that doesn’t get your motivation down, and you can participate in interviews and tests with positive spirits.
...
Spend 5 - 10 min looking at some examples in the portal [Rejected](https://rejected.us/).
