...
The timekeeper is the person who keeps track of time during meetings to avoid spending excessive time on one topic.
...
The notetaker is the person who takes quick, brief notes during meetings to keep a record of what has been decided or talked about during the meeting.

**Key tasks of the notetaker:**

- Write down essential points of what is discussed in meetings in a clear, comprehensive manner for other team members to understand.
- Make notes of tasks that have been assigned, who they have been assigned to, when the meeting will be scheduled, etc.
- Write all the meeting notes into the agenda document mentioned in point 3 above so that everyone in the team can what was discussed, what decisions were made, and how to prepare well before the next meeting.
- Share notes at the end of every meeting with all members of the group. One efficient way to do this is to put it on Google Drive, giving everyone permission to view it, and giving the leader/facilitator and timekeeper permission to edit so they can prepare the agenda for the next meeting in advance.
...
The code checker is the person who monitors the code quality of the project.

**Key tasks of the code checker:**

- Make sure that any code that needs to be optimized is optimized, and any code that needs refactoring is refactored.
- Make sure that all the code is clean, readable, and of good quality. If code is written that doesn't fit these criteria, the code checker should first speak with the team member who wrote the code to inform them that they will be making changes to the code. The code checker must also ensure a backup version of the existing code is saved to the repository before making any changes.
- Ensure that any new code that they create functions properly and does not create issues with other functionalities in the application. If it creates issues, the code must be reverted to its previous state.

## **Tester**

The tester is the person who writes and executes tests on the application to make sure that bugs are limited. 

**Key tasks of the tester:**
