...
- The **Summary** **field** is the first sentence of the LinkedIn description (for example, "*A weather app that pulls from the OpenWeatherMap API*"). The rest of the LinkedIn description goes in the AngelList **Description field** (for example, "*Users are able to select a location, choose between Fahrenheit and Celsius, and view allergen information*").
